...
public class BeneficiaryController {
	...
	public ResponseEntity<ApiResponse> createBeneficiary(@RequestBody BeneficiaryDetails beneficiaryDetails) {
		try {
			...
			return ResponseEntity.badRequest()
					.body(new ApiResponse(false, "Error creating beneficiary: " + e.getMessage()));
		}
	}
	...
	public ResponseEntity<ApiResponse> getBeneficiaryById(@PathVariable Long id) {
		try {
			...
			return ResponseEntity.badRequest()
					.body(new ApiResponse(false, "Error fetching beneficiary: " + e.getMessage()));
		}
	}
	...
	public ResponseEntity<ApiResponse> getBeneficiariesByEcrn(@PathVariable String ecrn) {
		try {
			...
			return ResponseEntity.badRequest()
					.body(new ApiResponse(false, "Error fetching beneficiaries: " + e.getMessage()));
		}
	}
	...
	@PutMapping("/{id}")
	public ResponseEntity<ApiResponse> updateBeneficiary(@PathVariable Long id,
			@RequestBody BeneficiaryDetails beneficiaryDetails) {
		try {
			...
			return ResponseEntity.badRequest()
					.body(new ApiResponse(false, "Error updating beneficiary: " + e.getMessage()));
		}
	}
	...
	public ResponseEntity<ApiResponse> deleteBeneficiary(@PathVariable Long id) {
		try {
			...
			return ResponseEntity.badRequest()
					.body(new ApiResponse(false, "Error deleting beneficiary: " + e.getMessage()));
		}
	}
	...
	public String getByIdNumber(@PathVariable("id") Long id, @RequestParam("status") boolean status) {
		...
		if (beneficiaryDetails != null) {
			beneficiaryDetails.setStatus(status);
