...
public class CustomerService {
	...
	@Transactional
	public String createCustomer(Customer customer, HttpServletRequest servletRequest) {
...
//						customerData.put("issued_on", null);
//					} else {
//						customerData.put("issued_on", idDetail.getIssuedOn());
//					}
////				idData.put("issued_on", "2024-06-12");
//					if (idDetail.getDateOfExpiry().isEmpty()) {
//						customerData.put("date_of_expiry", null);
//					} else {
//						customerData.put("date_of_expiry", idDetail.getDateOfExpiry());
//					}
//				idData.put("date_of_expiry", "2025-12-12");
//				idData.put("date_of_expiry", customer.getDateOfExpiry());
				idData.put("active_status", idDetail.getActiveStatus());
