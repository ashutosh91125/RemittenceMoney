...
// 	document.getElementById("passwordError").innerHTML = "";
	...
	if (!form.adminName.value.trim()) {
		document.getElementById("adminNameError").innerHTML = "Name is required.";
		isValid = false;
	}
		...
		<div class="page-header" style="background: aliceblue;">
				<div class="page-header-left d-flex align-items-center">
					...
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item">Lulu Staff Register</li>
					</ul>
				</div>
		...
		<div class="nxl-content p-3">
			<div class="main-content">
				<div class="card border-top-0">
					<form action="/lulu-staff-register" method="post" enctype="multipart/form-data"
