...
<!-- <script src="https://kit.fontawesome.com/a076d05399.js" crossorigin="anonymous"></script> -->
    ...
    <div class="container mx-0 my-3">
        <div class="row" style="display: flex;align-items: center;">  
                ...
                <div class="col-xl-2">
                  <div class="search-heading" id="search-heading">Customer Number:</div>
                </div>
        
                <div class="col-xl-3 ps-0">
                    <div class="search-bar-container d-flex" style="display: flex; justify-content: space-around; align-items: center;">
                        <input type="text" class="py-2" id="radio-search" placeholder="Search..." style="flex: 1;">
                        <span class="mt-2" style="margin-left: 8px;"><i class="feather-search"></i></span>
                    </div>
                </div>
...
<div class="accordion" id="accordionPanelsStayOpenExample">
            ...
            <div class="accordion-body" style="padding-top: 0; margin-top: 0;">
                <div class="card-body personal-info">
                    ...
                    <div class="row" style="margin-top: 0;">
                        ...
                        <div class="col-12 col-md-4">
                            <label class="form-label">Country of Nationality</label>
                            <select class="form-control" id="countryOfNationality" name="countryOfNationality">
                                <option value="us">United States</option>
                                <option value="uk">United Kingdom</option>
                            </select>
                        </div>
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-12">
                            <div class="row" style="margin-top: 0;">
                                ...
                                <!-- ID Issued By -->
                                <div class="col-12 col-md-4">
                                    <label class="form-label">ID Issued By</label>
                                    <input type="text" class="form-control" id="idIssuedBy" name="idIssuedBy"
                            ...
                            <div class="row mt-2" style="margin-top: 0;">
                                <!-- ID Issue Date -->
                                <div class="col-12 col-md-4">
                                    <label class="form-label">ID Date of Issue</label>
                                    <input type="date" class="form-control" id="idDateIssue" name="idDateIssue">
                                </div>
    
                                <!-- ID Expiry Date -->
                                <div class="col-12 col-md-4">
                                    <label class="form-label">ID Date of Expiry</label>
                                    <input type="date" class="form-control" id="idDateExpire" name="idDateExpire">
                                </div>
    
                                <!-- Country of Issue -->
                                <div class="col-12 col-md-4">
                                    <label class="form-label">Country</label>
                                    <select class="form-control" id="countryOfIssue" name="countryOfIssue">
                                        <option value="us">United States</option>
                                        <option value="uk">United Kingdom</option>
                                    </select>
                                </div>
    ...
    <h2 class="accordion-header">
        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
            ...
            aria-controls="panelsStayOpen-collapseTwo" style="background: aliceblue;">
            Beneficiary Details [Lulu-Remit]
        </button>
    </h2>
                    ...
                    <div class="row" style="margin-top: 0;">
                        ...
                        <div id="toBankForm">
                                    ...
                                    <div class="mb-1">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-4">
                                                ...
                                                <select class="form-control" id="payoutCountry" name="payoutCountry">
                                            ...
                                            <div class="col-12 col-md-4">
                                                ...
                                                <select class="form-control" id="payoutCurrency" name="payoutCurrency">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <a href="#">Advance Search</a> | <a href="#">Bank Branch Info</a>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="confirmAccountNo" name="confirmAccountNo" placeholder="Confirm Account No.">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-4">
                                                <div class="mb-1">
                                                    ...
                                                    <select class="form-control" id="beneficiaryType" name="beneficiaryType">
                                                        <option value="individual">Individual</option>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4">
                                    <div class="mb-1">
                                        <label class="form-label">Beneficiary Account First Name</label>
                                        <input type="text" class="form-control" id="benfFirstName" name="benfFirstName" placeholder="First Name">
                                    </div>
                                </div>
                        
                                <div class="col-12 col-md-4">
                                    <div class="mb-1">
                                        <label class="form-label">Beneficiary Account Middle Name</label>
                                        <input type="text" class="form-control" id="benfMiddleName" name="benfMiddleName" placeholder="Middle Name">
                                    </div>
                                </div>
                        
                                <div class="col-12 col-md-4">
                                    <div class="mb-1">
                                        <label class="form-label">Beneficiary Account Last Name</label>
                                        <input type="text" class="form-control" id="benfLastName" name="benfLastName" placeholder="Last Name">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4">
                                    <div class="mb-1">
                                        <label class="form-label">Beneficiary Address 1</label>
                                        <input type="text" class="form-control" id="benfAddress1" name="benfAddress1" placeholder="Address">
                                    </div>
                                </div>
                        
                                <div class="col-12 col-md-4">
                                    <div class="mb-1">
                                        <label class="form-label">Beneficiary Address 2</label>
                                        <input type="text" class="form-control" id="benfAddress2" name="benfAddress2" placeholder="Address 2">
                                    </div>
                                </div>
                        
                                <!-- Beneficiary City Label and Input -->
                                <div class="col-12 col-md-4">
                                    <label class="form-label">Beneficiary City</label>
                                    <input type="text" class="form-control" id="beneficiaryCity" name="beneficiaryCity" placeholder="City">
                                </div>
                            </div>
                                    ...
                                    <div class="mb-1">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="beneficiaryState" name="beneficiaryState" placeholder="State">
                                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-1 d-flex align-items-center">
                                        <label class="form-label me-2">Own Account</label>
                                        <input type="checkbox" id="ownAccount" name="ownAccount">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="toMobileForm" style="display: none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <label class="form-label">Mobile No.</label>
                                    <div class="d-flex">
                                        <select class="form-control me-2" id="countryCode" name="countryCode" style="width: auto;">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const toMobileForm = document.getElementById('toMobileForm');
    ...
    <div class="accordion-item">
        <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                ...
                aria-controls="panelsStayOpen-collapseThree" style="background: aliceblue;">
                Transaction Details
            </button>
        </h2>
                ...
                <div class="card-body personal-info">
                    <div class="card-body pass-security">
                            <div class="row">
                                <div class="col-xl-4">
                                    <div>
                                        <label class="form-label">PayIn Currency<span class="text-danger">*</span></label>
                                        <select class="form-control" id="payInCurrency" name="payInCurrency">
                                ...
                                <div class="col-xl-4">
                                    <div>
                                        <label class="form-label">Source of Fund<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" placeholder="Source of Fund" id="sourceOfFund" name="sourceOfFund">
                                    </div>
                                </div>
                                <div class="col-xl-4">
                                    <div>
                                        <label class="form-label">Transaction Purpose<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" placeholder="Transaction Purpose" id="transactionPurpose" name="transactionPurpose">
                                    </div>
                                </div>
                                <div class="col-xl-4">
                                    <div>
                            ...
                            <div class="row">
                                <div class="col-xl-4">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" placeholder="Payout Amount" id="payoutAmount" name="payoutAmount">
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" placeholder="Pay In Amount" id="payInAmount" name="payInAmount">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-2">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" placeholder="Commission" id="commission" name="commission" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-2">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" placeholder="Tax" id="tax" name="tax" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-2">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" placeholder="Other Charges" id="otherCharges" name="otherCharges" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-2">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" placeholder="Rate" id="dynamicRate" name="dynamicRate" readonly>
                                    </div>
                                </div>
    
                                <div class="col-xl-4">
                                    <div>
                                        <label class="form-label">Total Pay In Amount</label>
                                        <input type="text" class="form-control" placeholder="Total Pay In Amount" id="totalPayInAmount" name="totalPayInAmount" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-4">
    ...
    <!-- [ Main Content ] end -->
        ...
        <!-- [ Footer ] start -->
        <footer class="footer" style="background: aliceblue;">
